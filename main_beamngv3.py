...
def main():
    ...
    try:
        ...
        scenario = Scenario('east_coast_usa', 'Driver Impairment Test',
                            description='You may continue when ready.', authors='University of Gothenburg',
       ...
       # ) 	
        ...
        npc_vehicles = [
            ...
            },
            {
                ...
                'rot': (0, 0, -0.662620, 0.748956)  # Same rotation as npc7
            },
            {
                'name': 'npc9',
...
#### respawning
	    ...
	    # Voice prompt trigger
            ...
            if not voice_prompt_played_8 and dist3(player_pos, (430, -800, 41)) < 20: #(470, -831, 43)
                #bng.display_gui_message("Please spell 'Norway'")
            ...
            if not voice_prompt_played_11 and dist3(player_pos, ((-731.8,481.8,22.4))) < 20:
                #bng.display_gui_message("Please spell 'alone'")
            ...
            ## CP2 Event 1
            if not voice_prompt_played_10 and dist3(player_pos, ((-175, 910, 35))) < 30:
                #bng.display_gui_message("Attention! Please spell 'Dollar'")
                speak_async("Please spell 'Dollar'")
            ...
            if not voice_prompt_played_17 and dist3(player_pos, (830, -759, 42)) < 20:
            ...
            for i, npc in enumerate(npc_vehicles):
                ...
                if distance < 100 and not npc_triggered[i]:
